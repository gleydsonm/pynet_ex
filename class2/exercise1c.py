...
if not found, try the modules directory. As last resource try the
modules package of home dir ~/applied_python/lib/python2.7/site-packages/
...
try:
    ...
    try:
        ...
        try:
            ...
            from my_func import my_func
            print 'Found in ~/applied_python/lib/python2.7/site-packages/'
        except ImportError:
            print 'my_func not installed. Double check your system install.'
            quit()
